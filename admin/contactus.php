...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($query) {
            $msg = "Pagina correttamente modificata";
        } else {
            $error = "Riprova, qualcosa è andato storto.";
        }
    }
?>
    <!DOCTYPE html>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Pagina contatti | itiTV</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Pagina contatti </h4>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="p-6">
                                        <div class="">
                                            ...
                                            <button type="submit" name="update" class="btn btn-success waves-effect waves-light">Aggiorna e modifica</button>
