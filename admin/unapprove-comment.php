...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['action'] == 'del' && $_GET['rid']) {
        ...
        $delmsg = "Commento cancellato permanentemente";
    }
...
?>
    ...
    <head>
        ...
        <title>Disapprova commenti | itiTV</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Disapprova commenti</h4>
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if ($delmsg) { ?>
                                    <div class="alert alert-danger" role="alert">
                                        <strong>Oddio, ERRORE!</strong> <?php echo htmlentities($delmsg); ?>
                                    </div>
                                <?php } ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($st == '0') : ?>
                                                                    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']); ?>" title="Disapprova commento"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
                                                                <?php else : ?>
                                                                    <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']); ?>" title="Approva commento"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
                                                                <?php endif; ?>
