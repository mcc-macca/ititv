...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Modifica notizia | itiTV</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Modifica notizia </h4>
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if ($msg) { ?>
                                    <div class="alert alert-success" role="alert">
                                        <strong>Wela! tutto ok!</strong> <?php echo htmlentities($msg); ?>
                                    </div>
                                <?php } ?>
                                        ...
                                        <div class="">
                                            <form name="addpost" method="post">
                                                <div class="form-group m-b-20">
                                                    <label for="exampleInputEmail1">Titolo notizia</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>Corpo</b></h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>Immagine</b></h4>
                                                            <img src="postimages/<?php echo htmlentities($row['PostImage']); ?>" width="300" />
                                                            <br />
                                                            <a href="change-image.php?pid=<?php echo htmlentities($row['postid']); ?>">Aggiorna immagine</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <button type="submit" name="update" class="btn btn-success waves-effect waves-light">Aggiorna </button>
