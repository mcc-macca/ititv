...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Dashboard - itiTV">
        <meta name="author" content="Macca Computer">
        <!-- App title -->
        <title>Dashboard | itiTV</title>
...
<?php include('includes/footer.php');?>
            ...
            <div class="side-bar right-bar">
                ...
                <h4 class="">Impostazioni</h4>
                <div class="setting-list nicescroll">
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Notifiche</h5>
                            <p class="text-muted m-b-0"><small>Hai veramente bisogno?</small></p>
                        </div>
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Accesso API</h5>
                            <p class="m-b-0 text-muted"><small>Abilita/Disabilita accesso</small></p>
                        </div>
                        <div class="col-xs-4 text-right">
                            <input type="checkbox" checked data-plugin="switchery" data-color="#7fc1fc" data-size="small"/>
                        </div>
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Aggiornamenti automatici</h5>
                            <p class="m-b-0 text-muted"><small>Tenere aggiornato</small></p>
                        </div>
                        <div class="col-xs-4 text-right">
                            <input type="checkbox" checked data-plugin="switchery" data-color="#7fc1fc" data-size="small"/>
                        </div>
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Staot online</h5>
                            <p class="m-b-0 text-muted"><small>Mostra stato a tutti</small></p>
                        </div>
                        <div class="col-xs-4 text-right">
                            <input type="checkbox" checked data-plugin="switchery" data-color="#7fc1fc" data-size="small"/>
                        </div>
