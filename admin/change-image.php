...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Modifica foto | itiTV</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Aggiorna immagine </h4>
                                            ...
                                            <div class="">
                                                <form name="addpost" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="card-box">
                                                                <h4 class="m-b-30 m-t-0 header-title"><b>Attuale immagine:</b></h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>Nuova immagine</b></h4>
