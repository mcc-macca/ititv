...
?>
    ...
    <head>
        ...
        <title>Gestisci categorie | itiTV</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Gestisci categorie</h4>
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if ($delmsg) { ?>
                                    <div class="alert alert-danger" role="alert">
                                        <strong>Oh no!</strong> <?php echo htmlentities($delmsg); ?>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="col-md-12">
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            ...
                                            <h4><i class="fa fa-trash-o"></i>Categorie Cancellate</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($row['PostingDate']); ?></td>
                                                            <td><?php echo htmlentities($row['UpdationDate']); ?></td>
                                                            <td><a href="manage-categories.php?resid=<?php echo htmlentities($row['id']); ?>"><i class="ion-arrow-return-right" title="Ripristina categoria"></i></a>
                                                                &nbsp;<a href="manage-categories.php?rid=<?php echo htmlentities($row['id']); ?>&&action=parmdel" title="Cancella permanentemente"> <i class="fa fa-trash-o" style="color: #f05050"></i> </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
                                                    } ?>
