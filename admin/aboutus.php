...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($query) {
            $msg = "Pagina modificata con successo ";
        } else {
...
?>
    ...
    <head>
        ...
        <title>Pagina informazioni | itiTV</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Pagina informazioni </h4>
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if ($error) { ?>
                                    <div class="alert alert-danger" role="alert">
                                        <strong>ERRORE!!!!!!!!</strong> <?php echo htmlentities($error); ?>
                                    </div>
                                <?php } ?>
                                        ...
                                        <div class="">
                                            <form name="aboutus" method="post">
                                                <div class="form-group m-b-20">
                                                    <label for="exampleInputEmail1">Titolo pagina</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>Dettagli pagina</b></h4>
                                            ...
                                            <button type="submit" name="update" class="btn btn-success waves-effect waves-light">Aggiorna e pubblica</button>
