...
if (strlen($_SESSION['login']) == 0) {
    ...
    if ($_GET['action'] == 'perdel' && $_GET['scid']) {
        ...
        $delmsg = "Sottocategoria cancellata permanentemente";
    }
...
?>
    ...
    <head>
        ...
        <title>Gestisci sottocategorie | itiTV</title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Gestisci sottocategorie</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Sottocategorie</a>
                                        </li>
                                        <li class="active">
                                            Gestisci sottocategoria
                                        </li>
                                    </ol>
                                ...
                                <div class="col-md-12">
                                    <div class="demo-box m-t-20">
                                        <div class="m-b-30">
                                            ...
                                            <h4><i class="fa fa-trash-o"></i>Cancella sottocategoria</h4>
