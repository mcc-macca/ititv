...
<head>
    ...
    <!-- App title -->
    <title>Password dimenticata | itiTV</title>
    ...
    <script type="text/javascript">
        function checkpass() {
            if (document.changepassword.newpassword.value != document.changepassword.confirmpassword.value) {
                alert('Nuove password non coincidenti');
                        ...
                        <div class="m-t-40 account-pages">
                            ...
                            <div class="account-content">
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <input type="password" class="form-control" id="userpassword" name="confirmpassword" placeholder="Conferma password">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <input type="password" class="form-control" id="userpassword" name="newpassword" placeholder="Nuova password">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group account-btn text-center m-t-10">
                                        <div class="col-xs-12">
                                            <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" type="submit" name="submit">Ripristina</button>
                                        </div>
                                    </div>
                                ...
                                <a href="../index.php"><i class="mdi mdi-home"></i>Torna all home</a>
                            </div>
                        </div>
                        <!-- end card-box-->
