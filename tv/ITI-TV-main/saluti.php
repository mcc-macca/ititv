...
<body>
    <header class="header">
        <img src="./assets/image/grezzo.png" id="logoITI">X<img src="./assets/image/logoITITVnormale.png" id="logoITI-TV">
    </header>

    <main class="main"><br><b>
        <div id="testo">ITI-TV VI AUGURA UNA BUONA ESTATE<br> E BUONA FORTUNA AI MATURANDI!</b></div>
    </main>
