...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <img src="assets/image/logoITITVnormale.png" id="logoititv">
        </header>
        <!--MAIN-->
        <main>
            <div id="com1">
                <div class="head">
                    ...
                    <div class="lin"></div>
                    <div class="title">Distribuzione carta dello studente</div>
                </div>
            ...
            <div id="com2">
                <div class="head">
                    ...
                    <div class="lin"></div>
                    <div class="title">COMUNICAZIONE 2</div>
                </div>
                <div class="cont">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque venenatis ipsum nec pulvinar venenatis. Morbi facilisis interdum mi ac imperdiet. Pellentesque eget rhoncus sapien. Nunc vitae diam eu nisl consequat iacu lis. Sed commodo gravida nunc quis dictum. Vivamus non iaculis velit. ciaoc siaoc soi. dic</div>
            </div>
            <div id="com3">
                <div class="head">
                    ...
                    <div class="lin"></div>
                    <div class="title">COMUNICAZIONE 3</div>
                </div>
                <div class="cont">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque venenatis ipsum nec pulvinar venenatis. Morbi facilisis interdum mi ac imperdiet. Pellentesque eget rhoncus sapien. Nunc vitae diam eu nisl consequat iacu lis. Sed commodo gravida nunc quis dictum. Vivamus non iaculis velit. ciaoc siaoc soi. dic</div>
            </div>
        </main>
        ...
        <footer>
            ...
            <div id="test-rosso">23:59 23&deg;</div>
